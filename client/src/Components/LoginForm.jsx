  ...
  return (
    <form className="w-80 h-max py-7 bg-white flex flex-col items-center justify-center rounded-md">
      ...
      <div>
        ...
        <input type="text" name="email" id="email" className="border-2 rounded-md w-64 p-1.5" placeholder="manoj@gmail.com"  />
      </div>
      <div>
        <label htmlFor="password" className="text-[14px]">Password:</label> <br />
        <input type="text" name="password" id="password"  className="border-2 rounded-md w-64 p-1.5" placeholder="password"  />
      </div>
       <button className="bg-[#1d4e91] p-1.5 w-64 text-white mt-4 rounded-sm"> Login In</button>
